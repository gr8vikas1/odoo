...
class ResConfigSettings(models.TransientModel):
    ...
    # ----------------------------------------------------------
    # Properties from muk_web_colors
    # ----------------------------------------------------------
    ...
    def COLOR_ASSET_LIGHT_URL(self):
        return "/ip_web_theme/static/src/scss/colors_light.scss"
    ...
    def COLOR_ASSET_DARK_URL(self):
        return "/ip_web_theme/static/src/scss/colors_dark.scss"
    ...
    def COLOR_ASSET_THEME_URL(self):
        return "/ip_web_theme/static/src/scss/colors.scss"
    ...
    # ----------------------------------------------------------
    # Fields Dark Mode from muk_web_colors
    # ----------------------------------------------------------
